...
import { useRegistrasi } from '../hooks/useAuth.mutate'
...
const { mutateAsync, isPending, isSuccess } = useRegistrasi()
...
<template>
  <div class="w-full flex flex-row-reverse">
    ...
    <div class="w-2/5 px-6 pt-8 bg-base-100/70 backdrop-blur-md relative overflow-hidden z-20">
      ...
      <h1 class="text-4xl font-semibold text-neutral-content relative z-10">Sign Up to OatMovie</h1>
      ...
      <form :onsubmit="handleSubmit" class="flex flex-col gap-4 px-2 pt-8 pb-4">
        ...
        <label class="input input-bordered flex items-center gap-2">
          ...
          <input type="password" class="grow" placeholder="*******" v-model="password" />
        </label>
